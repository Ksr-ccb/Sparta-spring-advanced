...
class ManagerServiceTest {
    ...
    @Test
    public void manager_목록_조회_시_Todo가_없다면_IRE_에러를_던진다() { //NullPointerException 이 아니라 InvalidRequestException
        // given
        long todoId = 1L;
    ...
    void todo의_user가_null인_경우_예외가_발생한다() {
        ...
        assertEquals("담당자를 등록하려고 하는 유저나 일정을 만든 유저가 유효하지 않습니다.", exception.getMessage());
    }
